public class Parser
{
   ...
   private static boolean isAddOp(int tkcode)
   {
      return tkcode == Constants.TK_PLUS || tkcode == Constants.TK_MINUS;
   }

   private static boolean isMultOp(int tkcode)
   {
   ...
   private static Expression newBinaryOp(int tkcode,
