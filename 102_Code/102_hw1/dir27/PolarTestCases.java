...
public class PolarTestCases {
	private static Point test1 = new PolarPoint(0,0);
	private static Point test2 = new PolarPoint(1,0);
	private static Point test3 = new PolarPoint(1,Math.PI/2);
	private static Point test4 = new PolarPoint(Math.sqrt(8),Math.PI/4);
	private static Point test5 = new PolarPoint(Math.sqrt(8),-3*Math.PI/4);
